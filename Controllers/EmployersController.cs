...
namespace Advertisement_MVC_.Controllers
{
    public class EmployersController : Controller
    {
        ...
        public EmployersController(AdvertisementDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Employer_name,Date_of_establishment,Address_of_employer")] Employer employer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Employer_name,Date_of_establishment,Address_of_employer")] Employer employer)
        {
            if (id != employer.Id)
            {
                return NotFound();
